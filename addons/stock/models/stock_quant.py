        ...
        for package in self.mapped('package_id'):
            ...
            while package:
                ...
                if all_in:
                    ...
                    #ws-mps: set added to destinations for products with the same location
...
class QuantPackage(models.Model):
    ...
    def _compute_package_info(self):
        res = {}
        quants = self.env['stock.quant'].search([('package_id', 'child_of', self.ids)])  # TDE FIXME: was child_od
        for quant in quants:
            package = quant.package_id
            #ws-mps: look for the package in self of the current quant
